            ...
            className={`
              ...
              ${
                bulkLoading
                  ...
                  : 'bg-emerald-600 text-white hover:bg-emerald-700 dark:hover:bg-emerald-800 hover-btn-premium hover:shadow-lg hover:shadow-emerald-500/30 active:scale-[0.98]'
              } 
            ...
            return (
              <div
                ...
                className={`
                  ...
                  ${
                    isConfigured
                      ? 'bg-white dark:bg-gray-800 shadow-sm dark:shadow-gray-700/50 border-gray-100 dark:border-gray-700 hover-card-premium hover:border-blue-200 dark:hover:border-blue-800'
                ...
                {isConfigured ? (
                  ...
                  <div className="mt-4">
                    <button
                      ...
                      className="text-sm text-blue-500 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium hover-btn-premium transition-colors"
                    >
